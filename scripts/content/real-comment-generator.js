 ...
 */
export async function generateRealComments(
  platform = 'reddit',
  storyContext = {}
) {
...
function generateFallbackComments(platform, category) {
  ...
  const fallbackTemplates = {
    reddit: {
      general: [
        ...
        {
          content: 'OP delivered. What a wild ride from start to finish.',
          author: 'storytime_fan',
          upvotes: 3421,
        },
        {
          content:
            'I was not prepared for that plot twist. Absolutely unhinged.',
          author: 'plot_twist_lover',
          upvotes: 2345,
        },
        {
          content: "The fact that this actually happened... I can't even.",
          author: 'shocked_reader',
          upvotes: 1234,
        },
      ],
      celebrity: [
        {
          content: 'Celebrity PR teams are working overtime after this one.',
          author: 'pr_insider',
          upvotes: 5678,
        },
        {
          ...
          author: 'media_watcher',
          upvotes: 4567,
        },
        {
          content: 'This is going to be in every tabloid by tomorrow.',
          author: 'gossip_guru',
          upvotes: 3456,
        },
        {
          content: 'Their publicist just quit after reading this, guaranteed.',
    ...
    twitter: {
      general: [
        {
          content: "This whole thread is unhinged and I'm here for it",
          author: '@chaos_lover',
          likes: 12453,
          retweets: 3421,
        },
        {
          content: "The way this escalated... I can't breathe 💀",
          author: '@dead_rn',
          likes: 9876,
          retweets: 2345,
        },
        {
          content: 'Quote tweeting for posterity before it gets deleted',
          author: '@archive_queen',
          likes: 7654,
          retweets: 1234,
        },
        {
          content: 'Not the plot twist in tweet 7/23 😭😭😭',
          author: '@plot_twist',
          likes: 5432,
          retweets: 987,
        },
  ...
  const platformComments =
    fallbackTemplates[platform] || fallbackTemplates.reddit;
  const categoryComments =
    platformComments[category] || platformComments.general;
