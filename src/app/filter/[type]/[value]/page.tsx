...
export default function FilterPage() {
  ...
  const filterTitle = type === 'category' ? `${displayValue} Stories` : `Stories by ${displayValue}`;
  const filterDescription = type === 'category' 
        ...
        <section className="bg-gradient-to-r from-orange-600 to-orange-500 text-white py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl">
              <div className="mb-4">
                <span className="bg-black px-4 py-2 rounded-full text-sm font-bold">
              ...
              <div className="flex items-center gap-6 text-sm">
                ...
                <span>{Math.floor(Math.random() * 500) + 200} total comments</span>
