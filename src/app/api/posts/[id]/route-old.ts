    ...
    content: {
      sections: [
        ...
        },
        {
          type: 'image',
          content:
            'The battleground: A perfectly innocent pizza slice that would soon divide the internet into warring factions of reheating purists',
          metadata: { image_prompt: 'leftover pizza slice on a plate' },
        },
        {
          type: 'quotes',
          content:
            'Imagine gatekeeping happiness and then calling other people barbarians for eating cold pizza at 2 AM during a breakdown.',
          metadata: {
        ...
        },
        {
          ...
          content:
            'As the thread exploded, people started sharing deeply personal pizza stories that nobody asked for but everyone needed to hear.',
          metadata: {
            comments: [
              {
                author: 'BrokeCollegeKid',
                content:
                  "Y'all had access to ovens? We had a microwave older than some of my professors and we were GRATEFUL.",
                score: 1247,
                replies: 89,
              },
              {
                ...
                content:
                  'My grandmother is rolling in her grave at this entire conversation. She never had a microwave and her leftover pizza was perfect every time.',
                score: 892,
                replies: 156,
              },
              {
                ...
                content:
                  "Chicago deep dish vs NY thin crust changes everything. You can't apply the same reheating rules to different pizza architectures.",
                score: 567,
                replies: 234,
              },
            ],
        ...
        },
        {
          type: 'quotes',
          content:
            "The fact that we're having a moral panic about microwave pizza while people are struggling to afford any pizza is peak internet energy.",
          metadata: {
    ...
    content: {
      sections: [
        ...
        },
        {
          type: 'quotes',
          content:
            'PSA: If you think putting ranch on pizza makes you "quirky" and "different," you\'re neither. You\'re just someone with questionable taste buds who peaked in middle school cafeteria culture.',
          metadata: {
        ...
        },
        {
          ...
          content:
            'What started as condiment shaming quickly devolved into class warfare disguised as taste discourse.',
          metadata: {
            comments: [
              {
                author: 'RanchDefender2023',
                content:
                  'Tell me you grew up with a full spice rack without telling me you grew up with a full spice rack.',
                score: 234,
                replies: 45,
              },
              {
                author: 'PizzaPurist',
                content:
                  'Ranch pizza slaps and your bougie taste buds can cope. Some of us didn\'t have access to "authentic" Italian cuisine, Karen.',
                score: 189,
                replies: 67,
              },
            ],
          ...
          metadata: {
            conversation: [
              ...
              },
              {
                ...
                handle: 'culinary_truth',
                content:
                  "Having access to proper seasoning doesn't make me privileged, it makes me someone who understands that pizza already has flavor.",
                timestamp: '3h',
                likes: 156,
                retweets: 23,
                replies: 312,
              ...
              },
              {
                ...
                handle: 'uncleBobeats',
                content:
                  "I'm 67 years old and I've been putting ranch on everything since 1987. This includes pizza, hamburgers, salad, other ranch, and once memorably, ice cream during a power outage. Come at me, Gen Z.",
                timestamp: '2h',
                likes: 3421,
                retweets: 892,
                replies: 234,
              ...
              },
              {
                ...
                content:
                  "The fact that we're having a moral panic about ranch dressing while people are struggling to afford any food is peak internet energy.",
                timestamp: '2h',
                likes: 2156,
                retweets: 567,
                replies: 143,
...
export async function GET(
  ...
  try {
    ...
    const transformedPost = {
      ...
      persona: {
        name:
          post.author === 'the-snarky-sage'
            ? 'The Snarky Sage'
            : post.author === 'the-dry-cynic'
              ? 'The Dry Cynic'
              : post.author === 'the-down-to-earth-buddy'
