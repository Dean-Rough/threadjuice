            ...
            <ul className='navigation'>
              <li className='menu-item-has-children'>
                ...
                <ul className='sub-menu'>
                  ...
                  <li className={pathname == '/index-2' ? 'active' : ''}>
                    <Link href='/index-2'>Home Interior</Link>
                  </li>
                  <li className={pathname == '/index-3' ? 'active' : ''}>
                    <Link href='/index-3'>Home Travel</Link>
                  </li>
                  <li className={pathname == '/index-4' ? 'active' : ''}>
                    <Link href='/index-4'>Home Technology</Link>
                  </li>
                  <li className={pathname == '/index-5' ? 'active' : ''}>
                    <Link href='/index-5'>Home NFT</Link>
                  </li>
                  <li className={pathname == '/index-6' ? 'active' : ''}>
                    <Link href='/index-6'>Home Fashion</Link>
                  </li>
                  <li className={pathname == '/index-7' ? 'active' : ''}>
                    <Link href='/index-7'>Home Adventure</Link>
                  </li>
                  <li className={pathname == '/index-8' ? 'active' : ''}>
              ...
              <li className='menu-item-has-children'>
                ...
                <ul className='sub-menu'>
                  ...
                  <li className={pathname == '/blog/1' ? 'active' : ''}>
