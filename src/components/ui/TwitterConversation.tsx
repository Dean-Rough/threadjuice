...
export default function TwitterConversation({
  ...
  return (
    <div className={`twitter-conversation bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden jaunty-cutout ${className}`}>
      {/* Header */}
        ...
        {conversation.map((tweet, index) => (
          <div key={tweet.id} className="relative">
            ...
            {index < conversation.length - 1 && (
              <div className="absolute left-8 top-14 w-0.5 h-4 bg-slate-200 dark:bg-slate-600 z-0" />
            )}
            
            <div className="flex gap-3 p-4 border-b border-slate-100 dark:border-slate-700 last:border-b-0 relative z-10">
              {/* Avatar */}
              <div
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="ml-auto">
                    <button className="p-1.5 rounded-full hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">
