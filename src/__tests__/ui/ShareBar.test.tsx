...
describe('ShareBar', () => {
  ...
  it('should apply correct variant classes', () => {
    const { rerender } = render(<ShareBar {...defaultProps} variant="vertical" />);
    let container = screen.getByText('Share this post').closest('.sarsa-share-bar');
  ...
  it('should render without WOWAnimation when animated is false', () => {
    ...
    expect(screen.getByText('Share this post').closest('.sarsa-share-bar')).toBeInTheDocument();
  });
  ...
  it('should apply custom className', () => {
    ...
    const container = screen.getByText('Share this post').closest('.sarsa-share-bar');
  ...
  it('should show correct icons for each platform', () => {
    ...
    const facebookButton = screen.getByRole('button', { name: /facebook/i });
    expect(facebookButton.querySelector('i')).toHaveClass('fab', 'fa-facebook-f');
  ...
  it('should handle all social platform clicks', () => {
    ...
    platforms.forEach(platform => {
      const button = screen.getByRole('button', { name: new RegExp(platform, 'i') });
