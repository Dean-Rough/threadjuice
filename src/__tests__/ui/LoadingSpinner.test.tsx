...
jest.mock('@/components/elements/WOWAnimation', () => ({
  WOWAnimation: ({ children, className, animation }: any) => (
    <div data-testid="wow-animation" data-animation={animation} className={className}>
      {children}
    </div>
  ),
}));
...
describe('LoadingSpinner', () => {
  ...
  it('should apply correct size classes', () => {
    ...
    let container = screen.getByRole('status').closest('.sarsa-loading-spinner');
  ...
  it('should render dots variant correctly', () => {
    ...
    const dotsContainer = screen.getByRole('status').querySelector('.sarsa-loading-spinner__dots');
  ...
  it('should render pulse variant correctly', () => {
    ...
    const pulseContainer = screen.getByRole('status').querySelector('.sarsa-loading-spinner__pulse');
    expect(pulseContainer).toBeInTheDocument();
    
    const rings = pulseContainer?.querySelectorAll('.sarsa-loading-spinner__pulse-ring');
  ...
  it('should render bars variant correctly', () => {
    ...
    const barsContainer = screen.getByRole('status').querySelector('.sarsa-loading-spinner__bars');
  ...
  it('should render sarsa variant with logo correctly', () => {
    ...
    const sarsaContainer = screen.getByRole('status').querySelector('.sarsa-loading-spinner__sarsa');
  ...
  it('should render default variant with SVG circle', () => {
    ...
    const circleContainer = screen.getByRole('status').querySelector('.sarsa-loading-spinner__circle');
  ...
  it('should render without WOWAnimation when animated is false', () => {
    ...
    expect(screen.getByRole('status').closest('.sarsa-loading-spinner')).toBeInTheDocument();
  });
  ...
  it('should apply custom className', () => {
    ...
    const container = screen.getByRole('status').closest('.sarsa-loading-spinner');
