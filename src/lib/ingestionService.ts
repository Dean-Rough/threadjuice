import { redditScraper, isPostSuitable, cleanRedditText } from './redditScraper';
...
export class IngestionService {
  constructor() {
    ...
    jobQueue.registerWorker('reddit_ingestion', this.processRedditIngestion.bind(this));
  }
  ...
  private async processRedditIngestion(job: Job): Promise<IngestionResult[]> {
    ...
    try {
      ...
      logger.info('Fetching Reddit posts', { subreddit: data.subreddit, limit: data.limit });
   ...
   */
  private mapPersonaToGPT(persona: 'snarky-sage' | 'buddy' | 'cynic'): 'The Snarky Sage' | 'The Down-to-Earth Buddy' | 'The Dry Cynic' {
    const personaMap = {
