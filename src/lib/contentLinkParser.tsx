...
const LINK_PATTERNS: { [key: string]: LinkData } = {
  ...
  TikTok: {
    ...
    preview: {
      ...
      description:
        'Find out what your pizza reheating method says about your personality in this viral quiz.',
      domain: 'TikTok',
    },
  },
  '"definitive guides"': {
    ...
    preview: {
      ...
      description:
        'Complete with step-by-step photos and affiliate links to pizza stones.',
      domain: 'Food Blogs',
    },
  },
