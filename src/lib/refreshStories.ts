...
const newViralStories = [
  {
    title:
      'My Boss Made Me Work Christmas Day, So I Gave Him the Gift of Malicious Compliance',
    slug: 'boss-christmas-malicious-compliance',
    excerpt:
      'When my micromanager boss demanded I work Christmas Day "for the team," I followed his instructions so perfectly that he regretted every word. Sometimes the best revenge is giving people exactly what they ask for.',
      ...
      sections: [
        {
          type: 'image',
          content:
            'A person sitting alone in a dark office on Christmas Day, surrounded by perfectly organized files and a computer screen showing "TASK COMPLETED" while Christmas decorations gather dust in the background',
          metadata: {
            image_prompt:
              'empty office christmas day malicious compliance boss micromanager',
          },
        },
        {
          type: 'describe-1',
          ...
          metadata: {
            comments: [
              ...
              },
              {
                ...
                content:
                  '6:15 AM - Checked all 47 company emails. No urgent issues. Forwarded holiday greetings from vendors to Kevin\'s personal phone as potential "urgent matters."',
                score: 3156,
                replies: 124,
              },
              {
                ...
                content:
                  '8:30 AM - Client called! ...to wish us Merry Christmas. Immediately contacted Kevin to report "client communication." He did not appreciate the 8:30 AM holiday wake-up call.',
                score: 4523,
                replies: 203,
              },
            ],
        ...
        },
        {
          ...
          content:
            'But the real magic happened when I started interpreting "handle any urgent issues" with Christmas Day creativity:',
          metadata: {
            comments: [
              {
                author: 'MaliciousComplianceGod',
                content:
                  '11:00 AM - Office temperature dropped to 68°F. This could affect equipment performance. Called Kevin to authorize heating adjustment. He was opening presents with his kids.',
                score: 5234,
                replies: 156,
              },
              {
                ...
                content:
                  '2:00 PM - Cleaning crew had questions about trash schedule due to holiday. Called Kevin for "urgent operational decision." His family dinner did not appreciate the interruption.',
                score: 4876,
                replies: 198,
              },
              {
                ...
                content:
                  '4:00 PM - Security guard mentioned parking lot light was flickering. Potential safety issue requiring immediate management approval. Kevin stopped answering his phone after this one.',
                score: 6123,
                replies: 267,
              },
            ],
  ...
  {
    title:
      'My Roommate\'s "Influencer" Girlfriend Tried to Turn Our Apartment Into Her Personal Studio',
    slug: 'roommate-influencer-girlfriend-apartment-takeover',
    excerpt:
      'She moved in "temporarily" and immediately started rearranging our furniture for her TikToks. When I objected, she offered to "collaborate" for "exposure." Time for some creative boundary-setting.',
      ...
      sections: [
        {
          type: 'paragraph',
          content:
            "Hey friends, grab some popcorn because today's roommate tale involves ring lights, kitchen rearrangements, and the kind of audacity that makes you question humanity.",
        },
        {
          type: 'paragraph',
          content:
            'So my roommate Jake started dating this girl, Madison, who describes herself as a "lifestyle influencer" with 2,300 followers. Nothing wrong with that – everyone starts somewhere, right? The problem started when her "temporary" stay became a permanent apartment makeover project.',
        },
      ],
    },
  ...
  {
    title:
      'AITA for Exposing My Sister\'s "Perfect Life" Instagram at Family Dinner?',
    slug: 'sister-fake-instagram-family-dinner-exposed',
    excerpt:
      'My sister has been posting fake luxury content for months while secretly borrowing money from family. When she tried to shame me for my "unsuccessful" life at dinner, I brought receipts.',
    category: 'aita',
      ...
      sections: [
        {
          type: 'paragraph',
          content:
            "Ah, family dinners. That special time when relatives gather to judge each other's life choices while pretending to care about the cranberry sauce recipe.",
        },
        {
          type: 'paragraph',
          content:
            'My sister Jessica has always been... theatrical. But lately, her Instagram has showcased a lifestyle that would make billionaires jealous. Designer bags, luxury vacations, expensive restaurants – all while she\'s been "between jobs" for eight months.',
        },
      ],
    },
  ...
  {
    title:
      'My Neighbor\'s "Service Dog" Turned Out to Be a Stolen Pet – The Plot Twist Will Shock You',
    slug: 'neighbor-fake-service-dog-stolen-pet-scandal',
    excerpt:
      'For months, my neighbor paraded around with her "emotional support" dog, using it to access places pets aren\'t allowed. Then I saw a missing pet poster that changed everything.',
    category: 'neighbor',
    author: 'The Snarky Sage',
    personaId: 1,
      ...
      sections: [
        {
          type: 'paragraph',
          content:
            "Buckle up, dear readers, because today's tale of neighborhood drama comes with more plot twists than a soap opera and approximately 47% more criminal activity than your average Karen encounter.",
        },
        {
          type: 'paragraph',
          content:
            'Meet Brenda, my neighbor who moved in six months ago with her "emotional support dog," a beautiful Golden Retriever named Sunshine. Brenda was very vocal about Sunshine\'s status, bringing up the dog\'s "certification" in every conversation and making sure everyone knew her rights under the ADA.',
        },
      ],
    },
  ...
  {
    title:
      'Restaurant Customer Tries to Pay $127 Bill with "Exposure" – Manager\'s Response is LEGENDARY',
    slug: 'restaurant-customer-exposure-payment-manager-response',
    excerpt:
      'A wannabe food blogger with 500 followers tried to get a free meal by offering "promotion" instead of payment. The manager\'s solution was absolutely brilliant.',
    category: 'customer',
    author: 'The Down-to-Earth Buddy',
    personaId: 2,
      ...
      sections: [
        {
          type: 'paragraph',
          content:
            'Hey everyone! Today\'s story comes from the wild world of food service, where entitled customers think "exposure" pays rent and managers occasionally serve justice hotter than the soup special.',
        },
        {
          type: 'paragraph',
          content:
            'Our tale begins at Luigi\'s Family Restaurant, a cozy Italian place where the pasta is homemade and the patience for nonsense is limited. Enter our protagonist: "Food Blogger" Brittany, who ordered enough food for four people then announced she couldn\'t pay because she was "promoting" the restaurant.',
        },
      ],
    },
  ...
  {
    title:
      "My Date Tried to Make Me Pay for Her Ex-Boyfriend's Meal – Plot Twist of the Century",
    slug: 'date-pay-ex-boyfriend-meal-plot-twist',
    excerpt:
      "What started as a normal Tinder date turned into the most bizarre love triangle scam I've ever witnessed. The audacity levels were off the charts, but karma had the last laugh.",
    category: 'dating',
    author: 'The Dry Cynic',
    personaId: 3,
      ...
      sections: [
        {
          type: 'paragraph',
          content:
            "Dating apps are a fascinating study in human psychology, where people present their best selves while secretly harboring the chaos of reality television. Today's tale proves that sometimes reality is stranger than any script.",
        },
        {
          type: 'paragraph',
          content:
            'I matched with Sarah on Tinder. Normal conversation, shared interests, agreeable personality. We planned dinner at a mid-tier restaurant – nothing fancy, just good food and conversation. What could go wrong? Oh, sweet summer me...',
        },
      ],
    },
...
async function refreshStories() {
  ...
  for (const post of posts) {
    ...
    // Create shares
    for (let i = 0; i < Math.min(post.shareCount, 50); i++) {
    ...
    // Create bookmarks
    for (let i = 0; i < Math.min(post.bookmarkCount, 30); i++) {
      // Limit to prevent too many records
      await prisma.userInteraction.create({
        data: {
          postId: post.id,
