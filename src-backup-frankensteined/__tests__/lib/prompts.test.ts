...
describe('Persona Prompts', () => {
  describe('PERSONA_PROMPTS constant', () => {
    ...
    it('should have unique voice characteristics for each persona', () => {
      ...
      const buddyPrompt =
        PERSONA_PROMPTS['The Down-to-Earth Buddy'].systemPrompt;
  ...
  describe('getContentGuidelines function', () => {
    ...
    it('should include content-type specific requirements', () => {
      const articleGuidelines = getContentGuidelines(
        'The Snarky Sage',
        'article'
      );
      const summaryGuidelines = getContentGuidelines(
        'The Snarky Sage',
        'summary'
      );
      const quizGuidelines = getContentGuidelines(
        'The Snarky Sage',
        'quiz_intro'
      );
  ...
  describe('Content Structure Guidelines', () => {
    it('should have persona-specific content blocks', () => {
      const snarkyStructure =
        PERSONA_PROMPTS['The Snarky Sage'].contentStructure;
      const buddyStructure =
        PERSONA_PROMPTS['The Down-to-Earth Buddy'].contentStructure;
  ...
  describe('Example Outputs', () => {
    ...
    it('should demonstrate persona voice in examples', () => {
      const snarkyExample = JSON.parse(
        PERSONA_PROMPTS['The Snarky Sage'].exampleOutput
      );
      const buddyExample = JSON.parse(
        PERSONA_PROMPTS['The Down-to-Earth Buddy'].exampleOutput
      );
      const cynicExample = JSON.parse(
        PERSONA_PROMPTS['The Dry Cynic'].exampleOutput
      );

      // Snarky should be witty/sarcastic
      expect(snarkyExample.hook).toMatch(
        /(digital wasteland|common sense.*die)/i
      );
