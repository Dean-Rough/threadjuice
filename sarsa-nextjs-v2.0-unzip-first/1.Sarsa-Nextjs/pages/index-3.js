        ...
        <section className='tgbanner__area-three pt-80'>
          <div className='container'>
            <div className='row align-items-lg-center justify-content-around'>
              <div className='col-xl-3 col-lg-5 col-md-6 order-xl-0 order-2'>
              ...
              <div className='col-xl-6 col-lg-8 order-xl-2 order-0'>
              ...
              <div className='col-xl-3 col-lg-5 col-md-6 order-xl-3 order-3'>
